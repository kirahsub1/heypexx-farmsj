...
const Page: React.FC = () => {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-blue-100 px-4">
      <section className="w-full max-w-6xl bg-white shadow-2xl rounded-2xl overflow-hidden border border-blue-100">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-12 w-full flex flex-col justify-center">
            <h2 className="text-4xl text-center font-extrabold text-green-700 mb-2">
              Set a New Password
            </h2>
